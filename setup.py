...
# # PGSR diff-plane-rasterization
# setup(
#     name="diff_plane_rasterization",
#     packages=["diff_plane_rasterization"],
#     package_dir={"": "thirdparty/diff-plane-rasterization"},
#     ext_modules=[
#         CUDAExtension(
#             name="diff_plane_rasterization._C",
#             sources=[
#                 "thirdparty/diff-plane-rasterization/cuda_rasterizer/rasterizer_impl.cu",
#                 "thirdparty/diff-plane-rasterization/cuda_rasterizer/forward.cu",
#                 "thirdparty/diff-plane-rasterization/cuda_rasterizer/backward.cu",
#                 "thirdparty/diff-plane-rasterization/rasterize_points.cu",
#                 "thirdparty/diff-plane-rasterization/ext.cpp",
#             ],
#             extra_compile_args={
#                 "nvcc": [
#                     "-I"
#                     + os.path.join(
#                         os.path.dirname(os.path.abspath(__file__)),
#                         "thirdparty/diff-plane-rasterization/third_party/glm/",
#                     )
#                 ]
#             },
#         )
